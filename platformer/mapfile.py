    ...
    def __init__(self, filename):
        ...
        for child in element:
            ...
            # is this a layer we know how to process?
                ...
                # load a forground layer
                elif child.attrib['name'] == 'forground':
                    if len(self.forground) > 0:
                        print >>sys.stderr, 'MapFile: >1 forground layers found'
                        sys.exit(1)
                    self.forground = self._loadLayer(child, 'forground')
